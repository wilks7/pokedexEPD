...
from .sprite import fetchSprite
from ..layout.PokedexLayout import PokedexLayout
...
class PokedexPaper:
    def __init__(self, epd, rotation, vcom, generation):
        ...
        self.layout = PokedexLayout(self.screen.resolution, 'L', generation)
        self.width = width
        self.height = height
